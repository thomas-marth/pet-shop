...
<<<<<<< ours
      style={{ height: showFull ? "auto" : "548px" }}
=======
    ...
    >
      <div className={styles.left}>
        {related.map((p) => {
          ...
          return (
            <NavLink key={p.id} to={`/products/${p.id}`} className={styles.thumb}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.prices}>
          ...
          {discount && <span className={styles.oldPrice}>${product.price}</span>}
          {discount && <span className={styles.badge}>-{discount}%</span>}
        </div>
<<<<<<< ours
        <p className={`${styles.description} ${showFull ? styles.expanded : ""}`}>
          {product.description}
        </p>
